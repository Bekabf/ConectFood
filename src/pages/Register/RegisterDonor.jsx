...
export default function RegisterForm(){
  const [form, setForm] = useState({empresa:"", cnpj:"", responsavel:"", email:""})
  ...
  return (
    <main className="section">
      <Container>
        <h1 className="title-lg">Cadastro — Doador</h1>
        <form className="card mt-10" onSubmit={onSubmit}>

<label style={{marginTop:12}}>Empresa<input name="empresa" value={form.empresa} onChange={onChange} required style={{width:'100%', marginTop:6, padding:12, borderRadius:10, border:'1px solid #e5e7eb'}}/></label>
