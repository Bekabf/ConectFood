...
export default function RegisterForm(){
  const [form, setForm] = useState({ong:"", cnpj:"", contato:"", email:""})
  ...
  return (
    <main className="section">
      <Container>
        <h1 className="title-lg">Cadastro — ONG</h1>
        <form className="card mt-10" onSubmit={onSubmit}>

<label style={{marginTop:12}}>Nome da ONG<input name="ong" value={form.ong} onChange={onChange} required style={{width:'100%', marginTop:6, padding:12, borderRadius:10, border:'1px solid #e5e7eb'}}/></label>
...
<label style={{marginTop:12}}>Contato<input name="contato" value={form.contato} onChange={onChange} required style={{width:'100%', marginTop:6, padding:12, borderRadius:10, border:'1px solid #e5e7eb'}}/></label>
